...
public class DriverJDBC {
    ...
    /**
     * Indica que empieza una transacción, que acabará con el método
     * finTranssacion(), y que no actualizará la base de datos hasta hacer
     * commit.
     *
    ...
    /**
     * Deshace las consultas que no se han cometido en la base de datos con un
     * comit()
     *
     * @throws SQLException errores en la base de datos
     */
    ...
    /**
     * Finaliza una trasaccion, cerrando la conexión con la base de datos, y
     * restaurando el estado anterior para AutoCommit y para
